...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x03FF7FFFUL)  // Mask of available channels in ADC unit 0.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                              (0x03UL)        // Mask of 32-bit GPT channel indices.
...
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK                        (0xFFUL)        // Mask of channels that support event count input (has GTUPSR register).
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK                              (0xFFUL)        // Mask of channels that support dead time control.
...
#define BSP_FEATURE_GPT_MSTP_MSTPD5_MAX_CH                              (1UL)           // Largest channel number associated with GPT on the MSTPCRD.MSTPD5 field on this MCU.
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                               (0xDFFFUL)      // Mask of available IRQ control registers.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                                      (0xFB9FDFFFULL) // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                                   (0x7382DFFFULL) // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_SLCDC_CONTRAST_MAX                                  (15UL)          // Maximum contrast index for standard bias methods.
#define BSP_FEATURE_SLCDC_CONTRAST_MAX_4BIAS                            (6UL)           // Maximum contrast index for 1/4 bias method.
#define BSP_FEATURE_SLCDC_HAS_8_TIME_SLICE                              (1UL)           // LCD waveform supports 8-time slices.
#define BSP_FEATURE_SLCDC_HAS_INTERNAL_VOLT_GEN                         (1UL)           // Internal voltage generation is available.
...
#define BSP_FEATURE_SLCDC_MAX_NUM_SEG                                   (37UL)          // Maximum index of supported segment registers.
...
#define BSP_FEATURE_SSI_FIFO_NUM_STAGES                                 (8UL)           // Depth of the SSI data FIFO.
